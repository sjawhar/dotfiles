...
- Provenance on every constraint and rule you pass forward: mine, or inferred. A successor treats an inferred constraint as a hypothesis to verify, never as law — agents keep inheriting rules I never stated and obeying them. Mark which it is; don't quote me to do it. Provenance belongs in a handoff, a commit message, or a one-line citation — never pasted into the rule itself. A rule states the rule; my words quoted back at me in a skill, a PR body, or a message are clutter I have to read past.
